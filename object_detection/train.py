...
2) Three configuration files can be provided: 
    a. model_config.pbtxt = a model_pb2.DetectionModel configuration file to define what type of DetectionModel is being trained
    b. train_config.pbtxt = a train_pb2.TrainConfig file to configure training parameters.
    c. train_input_config.pbtxt = an input_reader_pb2.InputReader file to specify what training data will be used
